...
#| @return: N/A                                                               |
#+----------------------------------------------------------------------------+
class Periapsis_Theory_Modeler():
    ...
    def get_all_periapsis_data(self):
        ...
        symbol_stats = self.net_actual_position_records.groupby('Symbol').agg(
        ...
        # --- filter datasets
        self.net_actual_position_records     = self.net_actual_position_records[~self.net_actual_position_records['Symbol'].isin(worst_symbols)].copy()
        self.gross_actual_position_records   = self.gross_actual_position_records[~self.gross_actual_position_records['Symbol'].isin(worst_symbols)].copy()
        self.net_inverse_position_records    = self.net_inverse_position_records[~self.net_inverse_position_records['Symbol'].isin(best_symbols)].copy()
        self.gross_inverse_position_records  = self.gross_inverse_position_records[~self.gross_inverse_position_records['Symbol'].isin(best_symbols)].copy()
        ...
        pre_trade_cost_cum = (self.net_actual_position_records['Commission'] + self.net_actual_position_records['Swap']).cumsum().values
        ...
        self.net_actual_position_records['Gross Profit']    += per_trade_offset
        self.net_actual_position_records['Net Profit']      += per_trade_offset
        self.gross_actual_position_records['Gross Profit']  += per_trade_offset
        self.net_inverse_position_records['Gross Profit']   += per_trade_offset
        self.net_inverse_position_records['Net Profit']     += per_trade_offset
        self.gross_inverse_position_records['Gross Profit'] += per_trade_offset
        ...
        ##--- return the altered net actual data
        improved_cfd_position_records = self.net_actual_position_records
        return improved_cfd_position_records
...
if __name__ == '__main__':
    ...
    periapsis_theory_modeler = Periapsis_Theory_Modeler(cfd_position_records = cfd_position_records, inverse_position_records = inverse_position_records)
    
    ##--- perform edge analysis
    improved_cfd_position_records = periapsis_theory_modeler.get_all_periapsis_data()